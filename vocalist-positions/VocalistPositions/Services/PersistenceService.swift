...
private let logger = Logger(subsystem: "com.northwoods.VocalistPositions", category: "Persistence")
...
final class PersistenceService {
    ...
    init() {
        ...
        supportDir = appSupport.appendingPathComponent("VocalistPositions", isDirectory: true)
    ...
    // MARK: - Vocalist Positions

    func loadVocalistPositions() -> [VocalistPosition] {
        load(from: supportDir.appendingPathComponent("vocalists.json")) ?? []
    }

    func saveVocalistPositions(_ positions: [VocalistPosition]) {
        save(positions, to: supportDir.appendingPathComponent("vocalists.json"))
    }
    ...
    // MARK: - Published data for web display
