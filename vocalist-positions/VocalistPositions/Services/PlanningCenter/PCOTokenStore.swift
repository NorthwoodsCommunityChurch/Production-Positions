...
private let logger = Logger(subsystem: "com.northwoods.VocalistPositions", category: "PCOTokenStore")
...
final class PCOTokenStore {
    private static let serviceName = "com.northwoods.VocalistPositions.pco"
