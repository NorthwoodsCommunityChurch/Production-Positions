...
private let logger = Logger(subsystem: "com.northwoods.VocalistPositions", category: "DisplayServer")
...
final class DisplayServer {
    ...
    private let connectionQueue = DispatchQueue(label: "com.northwoods.VocalistPositions.connections")
